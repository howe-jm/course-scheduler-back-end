...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Student Schedule'), ['action' => 'edit', $studentSchedule->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Student Schedule'), ['action' => 'delete', $studentSchedule->id], ['confirm' => __('Are you sure you want to delete # {0}?', $studentSchedule->id), 'class' => 'side-nav-item']) ?>

        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $studentSchedule->schedule_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $studentSchedule->schedule_id]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $studentSchedule->schedule_id], ['confirm' => __('Are you sure you want to delete # {0}?', $studentSchedule->schedule_id)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
